        ...
        <div class="pt-2">
                 ...
                 <ul class="nav nav-tabs" id="myTab" role="tablist">
                  <li class="nav-item" role="presentation">
                    <a href="/lssp" style="text-decoration: none">
                  ...
                  <li class="nav-item" role="presentation">
                    <a href="/lssp/up" style="text-decoration: none">
                      <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="true">Upstream Operations</button>
                    </a>
                    </li>
                  <li class="nav-item" role="presentation">
                    <a href="/lssp/both" style="text-decoration: none">
                      <button class="nav-link active" id="contact-tab" data-bs-toggle="tab" data-bs-target="#contact" type="button" role="tab" aria-controls="contact" aria-selected="false">Both Operations</button>
                    </a>
                    </li>
                  </ul>
