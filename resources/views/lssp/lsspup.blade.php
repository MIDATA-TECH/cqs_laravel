                 ...
                 <ul class="nav nav-tabs" id="myTab" role="tablist">
                  ...
                  <li class="nav-item" role="presentation">
                    <a href="/lssp/up" style="text-decoration: none">
                      <button class="nav-link active" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="false">Upstream Operations</button>
                    </a>
                    </li>
                  <li class="nav-item" role="presentation">
                    <a href="/lssp/both" style="text-decoration: none">
                      <button class="nav-link" id="contact-tab" data-bs-toggle="tab" data-bs-target="#contact" type="button" role="tab" aria-controls="contact" aria-selected="true">Both Operations</button>
                    </a>
                    </li>
                  </ul>
